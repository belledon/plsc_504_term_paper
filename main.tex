...
\begin{figure}[h]
  \centering
  \scalebox{0.5}{
    \includegraphics{replication/output/dag.png}
  }
...
\begin{table}[ht]
  \begin{center}
    \scalebox{0.75}{
      \input{replication/output/table2.tex}
    }
...
%% \begin{center}
%% \footnotesize \input{replication/output/table3.tex}
%% \end{center}{}
%% \begin{center}
%% \footnotesize \input{replication/output/table4.tex}
%% \end{center}{}
...
\begin{table}[ht]
  \begin{center}
    \scalebox{0.75}{
      \input{replication/output/table1.tex}
    }
...
\begin{table}[ht]
  \begin{center}
    \scalebox{0.75}{
      \input{replication/output/table4.tex}
    }
...
\begin{table}[ht]
  \begin{center}
    \scalebox{0.75}{
      \input{replication/output/table5.tex}
    }
